...
/**
 * Contains the InvalidConfig Exception class
 *
 * License:
 *
...
/**
 * The invalid config exception class
 *
 * This Exception class is thrown when their is an issue loading the config file.
 *
